/*
 * cfltk - Fl_Radio_Button.c
 * See include/cfltk/Fl_Radio_Button.h for the class-conversion notes.
 */
#include <stdlib.h>

#include "cfltk/Fl_Radio_Button.h"
...
Fl_Button *Fl_Radio_Button_new(int x, int y, int w, int h, const char *label) {
    ...
    Fl_Radio_Button_init(self, x, y, w, h, label);
    return self;
}
